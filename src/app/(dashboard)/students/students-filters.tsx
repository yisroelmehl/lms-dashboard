    ...
    <>
      <form onSubmit={handleSubmit} className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700 transition-colors flex items-center gap-2"
        >
          <span>+</span> הוסף תלמיד חדש
        </button>
      </form>
